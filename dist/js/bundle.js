...
const ListaProductos = __webpack_require__(5);
const editarProductosVista = __webpack_require__(28);
class productoModule {
    constructor() {
        this._productos = [];
        this._listaProductoModel = [];
        this._editarRegistros = [];
    }
    crear() {
        return __awaiter(this, void 0, void 0, function* () {
            let datos = {
                nombre_producto: document.querySelector("#NombreProducto").value,
                precio: parseInt(document.querySelector("#PrecioProducto").value),
                cantidad: parseInt(document.querySelector("#CantidadProducto").value)
            };
            yield config_1.axiosInstance.post("productos", datos).then((response) => {
                console.log("Respuesta del servidor:", response); // Verifica qué contiene la respuesta
                if (response.data.status) {
                    console.log("La acción fue realizada");
                    sweetalert2_1.default.fire("Exitoso!", "Preciona el boton!", "success");
                }
            }).catch(error => {
    ...
    listarProductos() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            config_1.axiosInstance.get("productos").then(({ data }) => {
                ...
                if (data.status) {
                    ...
                    document.querySelector("#tablaPrdoctos").innerHTML = ListaProductos({ productos });
                }
            }).catch(error => {
                console.log("Error en la solicitud", error);
                sweetalert2_1.default.fire({
    ...
    mostrarInformacionProductos(id) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.axiosInstance.get(`productos/${id}`).then(({ data }) => {
                if (data.status) {
    ...
    editarRegistro(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let editar = {
                nombre_producto: document.querySelector("#editarNombreProducto").value,
                precio: parseInt(document.querySelector("#editarPrecio").value),
                cantidad: parseInt(document.querySelector("#editarCantidad").value)
            };
            config_1.axiosInstance.put(`productos/${id}`, editar).then(({ data }) => {
...
exports["default"] = new productoModule();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"id_producto") || (depth0 != null ? lookupProperty(depth0,"id_producto") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id_producto","hash":{},"data":data,"loc":{"start":{"line":17,"column":16},"end":{"line":17,"column":31}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"nombre_producto") || (depth0 != null ? lookupProperty(depth0,"nombre_producto") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"nombre_producto","hash":{},"data":data,"loc":{"start":{"line":18,"column":16},"end":{"line":18,"column":35}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"precio") || (depth0 != null ? lookupProperty(depth0,"precio") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"precio","hash":{},"data":data,"loc":{"start":{"line":19,"column":16},"end":{"line":19,"column":26}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"cantidad") || (depth0 != null ? lookupProperty(depth0,"cantidad") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cantidad","hash":{},"data":data,"loc":{"start":{"line":20,"column":16},"end":{"line":20,"column":28}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"fecha_ingreso") || (depth0 != null ? lookupProperty(depth0,"fecha_ingreso") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"fecha_ingreso","hash":{},"data":data,"loc":{"start":{"line":21,"column":16},"end":{"line":21,"column":33}}}) : helper)))
    + "</td>\r\n            <td>\r\n                <button onclick=\"app.productoModule.mostrarInformacionProductos("
    + alias4(((helper = (helper = lookupProperty(helpers,"id_producto") || (depth0 != null ? lookupProperty(depth0,"id_producto") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id_producto","hash":{},"data":data,"loc":{"start":{"line":23,"column":80},"end":{"line":23,"column":95}}}) : helper)))
    + ");\" type=\"button\"\r\n                    class=\"fa-solid fa-pen-to-square btn btn-primary\" id=\"mostrar\">\r\n                    Editar\r\n                </button>\r\n            </td>\r\n            <td>\r\n                <div id=\"productoEditar\">\r\n                    <div id=\"formEditar\"></div>\r\n                </div>\r\n            </td>\r\n        </tr>\r\n";
  ...
  return "<table class=\"table table-striped my-0 dataTable no-footer\" aria-describedby=\"datatables-dashboard-projects_info\">\r\n    <h5 class=\"card-title mb-0\">Almacen</h5>\r\n    <thead>\r\n        <tr>\r\n            <th class=\"sorting sorting_asc\">Numero</th>\r\n            <th class=\"sorting sorting_asc\">Fruta</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Precio</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Cantidad</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Fecha Ingreso</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Editar</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Formulario</th>\r\n        </tr>\r\n    </thead>\r\n    <tbody>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"productos") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":15,"column":8},"end":{"line":34,"column":17}}})) != null ? stack1 : "")
    + "    </tbody>\r\n</table>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputEmail1\" class=\"form-label\">Nombre Producto</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"editarNombreProducto\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"nombre_producto") || (depth0 != null ? lookupProperty(depth0,"nombre_producto") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"nombre_producto","hash":{},"data":data,"loc":{"start":{"line":5,"column":87},"end":{"line":5,"column":106}}}) : helper)))
    + "\">\r\n    </div>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputPassword1\" class=\"form-label\">Precio</label>\r\n        <input type=\"number\" class=\"form-control\" id=\"editarPrecio\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"precio") || (depth0 != null ? lookupProperty(depth0,"precio") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"precio","hash":{},"data":data,"loc":{"start":{"line":9,"column":81},"end":{"line":9,"column":91}}}) : helper)))
    + "\">\r\n    </div>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputPassword1\" class=\"form-label\">Cantidad</label>\r\n        <input type=\"number\" class=\"form-control\" id=\"editarCantidad\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"cantidad") || (depth0 != null ? lookupProperty(depth0,"cantidad") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cantidad","hash":{},"data":data,"loc":{"start":{"line":13,"column":83},"end":{"line":13,"column":95}}}) : helper)))
    + "\">\r\n    </div>\r\n    <button type=\"button\" onclick=\"app.productoModule.editarRegistro();\" class=\"btn btn-primary\">Guardar</button>\r\n\r\n     <button type=\"button\" class=\"btn btn-secondary\" onclick=\"app.productoModule.cerraFormulario()\">Cerrar</button>\r\n</form>\r\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
